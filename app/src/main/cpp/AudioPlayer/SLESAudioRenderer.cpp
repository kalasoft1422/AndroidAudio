...
SLresult SLESAudioRenderer :: open()
{
...
{
    //KSLog::debug(TAG,"SLES calling back");
    SLresult result;
    static float phase = 0;
    SLESAudioRenderer *player = (SLESAudioRenderer *)context;
...
SLresult SLESAudioRenderer::createBufferQPlayer() {
...
SLresult SLESAudioRenderer::createEngine()
{
    SLresult  result = SL_RESULT_SUCCESS;
